...
If you are going to continue on to the other Intersight REST API Learning Lab, *do not remove them from your Intersight Account* as these devices are used in the following Learning Lab:

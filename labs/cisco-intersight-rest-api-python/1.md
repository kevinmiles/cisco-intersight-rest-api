...
All the exercises in the Introduction to the Cisco Intersight REST API with Python Learning Lab can be completed using the [Cisco Intersight Sandbox](https://devnetsandbox.cisco.com/RM/Diagram/Index/a63216d2-e891-4856-9f27-309ca61ec862?diagramType=Topology).
...
1. Open and Update the Intersight REST API code
  ...
  This will open the python file `intersight_ops.py` in the Python 3.7 IDLE editor.
